...
// ======= Aux exports (mínimos para que no truene nada en offline) =======
export { db, collection, onSnapshot, query, where, orderBy, limit, getDocs, addDoc, setDoc, updateDoc, doc, getDoc, deleteDoc, Timestamp, serverTimestamp, increment };
